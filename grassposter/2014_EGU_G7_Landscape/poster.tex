...
\begin{center}
\begin{tabular}{lcr}
\includegraphics[width=0.28\textwidth]{images/grass7-3d}
& ~ &
\includegraphics[width=0.49\textwidth]{images/house3D}\\
 Figure X: 3D handling & & Figure X: Chancellor's House, North Carolina State University
\end{tabular}
\end{center}
}
